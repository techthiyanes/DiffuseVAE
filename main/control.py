...
from vae_control.anno import gen_images
from models.vae import VAE

parser = argparse.ArgumentParser(description='vae control')
parser.add_argument('--logdir', type=str, default="/users/gpu/avideep/Kushagra/VAEDM/outputs")
parser.add_argument('--num', type=int, default=10)
parser.add_argument('--gpu', type=str, default="0")
parser.add_argument('--path', type=str, default="/users/gpu/avideep/Kushagra/VAEDM/outputs/models/vae-epoch=189-train_loss=0.00.ckpt")
