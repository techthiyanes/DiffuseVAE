...
python main/train_ae.py +dataset=celebamaskhq128/train \
                     ...
                     dataset.vae.training.results_dir=\'/data/kushagrap20/vae_alpha_0_01/\' \
                     dataset.vae.training.workers=4 \
                     dataset.vae.training.chkpt_prefix='celebamaskhq_alpha_0_01' \
                     dataset.vae.training.alpha=0.01
