# CelebAHQ training
python main/train_ae.py +dataset=celebahq256/train \
                     dataset.vae.data.root='/data/kushagrap20/datasets/celeba_hq/' \
                     dataset.vae.data.name='celebahq' \
                     dataset.vae.training.batch_size=12 \
                     dataset.vae.training.epochs=500 \
                     dataset.vae.training.device=\'gpu:1,2\' \
                     dataset.vae.training.results_dir=\'/data/kushagrap20/vae_celebahq256_alpha=1.0_Jan31/\' \
                     dataset.vae.training.workers=4 \
                     dataset.vae.training.chkpt_prefix=\'celebahq256_alpha=1.0_Jan31\' \
